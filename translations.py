STRINGS = {
    ...
    'en': {
        ...
        'shift_prompt':    "Shift the schedule for «{msg}» by how much?",
        'shifted':         "🔁 Schedule for «{msg}» shifted, next one at {time}",
        'btn_back':        "← Back",
        'page_of':         "Page {page} of {pages}, {total} total",
        'tz_moved':        "🔄 Reminders moved to the new city: {n}",
        'move_1d':         "⏩ +1 day",
        ...
        'voice_too_long':  "Voice message is too long — two minutes max.",
        'snoozed':         "⏰ {msg}\n\n⏩ Snoozed to {time}",
        'btn_close':       "✖ Close",
        'btn_delete':      "🗑 {msg}",
        'btn_accept':      "✅ Got it",
        ...
        'limit_notes':     "I can't keep more than {n} notes — delete some first.",

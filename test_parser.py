...
error_tests = [
    ...
    ("напомни 31.04 в 10:00 тест",                  "не существует"),
    ("напомни 30 февраля в 10:00 тест",             "не существует"),
    ("напомни 29 февраля поздравить",               "високос"),
    ("напомни через 0 минут",                       "близкое"),
...
field_tests = [
    ...
    ("напомни 15.09 в 10:00 отчёт", dict(type="once", message="отчёт", wall_clock=True)),
    ("напомни 15.09 отчёт", dict(type="once", message="отчёт")),
